...
<body>
    ...
    <div class="container row bread">
        <ol class="col-12 breadcrumb">
            ...
            <li class="breadcrumb-item "><a href="sponser.php">Sponsor</a></li>
    ...
    <div class="">
        ...
        <div class="heading">
            ...
            <div class="para">
                <p>Choose the options given below to check your Eligibilty. If you are eligible to adopt a child, then you can book your appointment
                    with the orphanage. In case, you are not eligible "Don't Worry" you can sponsor a child. </p>
            </div>
        </div>
        ...
        <div class="containere ">
            ...
            <div class="quiz-container" id="quiz">
                <div class="quiz-header">
                    <h2 id="question">Check Your Eligibilty</h2>
                    <ul class="ul">
                        <li class="ul">
                            ...
                            <div class="footer-item">
                                ...
                                <div class="textwidget">
                                    <p style="color: white;">
                                        ...
                                        Email: <a href="mailto:19co00.aiktc.ac.in" target="_top"
                                            style="color: #ffffff;">info@charity4cause.org</a><br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <p class="copyright">Website Designed By : <a href="http://www.saiwaytech.com/" target="_blank"
                                    style="color:yellow;">Group 3</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
const quizData = [{
        question: "Select the range of your Age",
        a: "Below 18",
        b: "Between 18-20",
        c: "Between 25-110",
        d: "More Than 110",
    ...
    {
        question: "Do you have any Criminal Background?",
        a: "Yes",
        b: "No",
        c: "Not Now",
        d: "Can't Reveal",
    ...
    },
    {
        ...
        a: "I have residence proof, birth proof but no identity proof.",
        b: "I do not have any documents.",
        c: "I have birth proof but no identity and residence proof.",
        d: "I have all the necessary documents.",
        correct: "d",
    },
    {
        question: "What type of Stability do you have?",
        a: "Physically and Mentally Stable but Financially unstable.",
        b: "Physically unstable but Mentally and financially stable.",
        c: "Physically, Mentally and Financially stable.",
        d: "Physically and Financially stable but , mentally unstable.",
        correct: "c",
    },
...
submitBtn.addEventListener('click', () => {
    ...
    if (answer) {
        ...
        if (currentQuiz < quizData.length) {
           ...
           <button onclick="location.reload()">Check Your Eligibility Again</button>
           `
        }
    }
})
