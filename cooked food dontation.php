    ...
    <div class="container">
        ...
        <div class="container-fluid  row  ">
            ...
            <div class="flip-box col-12 col-md-4">
                ...
                <a href="#Donate-money">
                    <center><button id="buttons" class="Button-2 btn btn-primary">Donate Money </button>
                    </center>
                </a>
            </div>
            <div class="flip-box col-12 col-md-4">
        ...
        <div class="main ">
            <div class="container row one">
                    ...
                    <div class="col col-sm order-lg-first col-lg">
                        <div class="media">
                            ...
                            <div class="media-body ">
                                ...
                                <p class="fixed1" style="font-weight: bold;">Donate Money for the welfare of the lone
                                    souls. Your
                ...
                <form action="" id="Donate-money" class="col-12  col-md-8">
                    ...
                    <center><button name="button" class="btn btn-warning col-4 offset-4 custom-btn">Submit</button>
                    </center>
                </form>
            ...
            <div class="container row two">
                    ...
                    <div class="col col-sm order-lg-first col-lg">
                        <div class="media">
                            ...
                            <div class="media-body ">
                                ...
                                <p class="fixed1" style="font-weight: bold;">Donate for the orphans and feed them. Feed
                                    them either
                ...
                <form action="cook.php" method="post" id="donate-food" class="col-12  col-md-8">
                    <center>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <input class="control-form " name="list" type="text" id="namef" placeholder="Enter the Name of  Cooked Food items "
                    ...
                    <center><button name="submit141" class="btn btn-warning col-4 offset-4 custom-btn">Submit</button>
                    </center>
            ...
            <div class="container row three">
                    ...
                    <div class="col col-sm order-lg-first col-lg">
                        <div class="media">
                            ...
                            <div class="media-body ">
                                ...
                                <p class="fixed1" style="font-weight: bold;">Donate Clothes for our childrens may be
                                    clothes are not
                                    good for you but for children your clothes can have a second
                                    chance. Donate Clothes in good condition and help the orphans. May be it is winter
                                    clothes or normal.
                                    "Charity is
                                    Prioty"</p>
                            </div>
                ...
                <form action="" id="donate-cloth" class="col-12  col-md-8">
                    <center>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="radio" class="control-form col-1" name="cloth-gen">
                    ...
                    <div id="carouselExampleControls " class="carousel slide cal" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <h3 class="text">Pack the clothes and volunteer will reach for recieving donations.
                                    </h3>
                                </div>
                            </div>
                        </div>
